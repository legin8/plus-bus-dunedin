<script>
  ...
  // This imports a component to place under the content of this component
  import RunDays from "./SupermarketDays.svelte";
</script>
...
<div>
  <div class="dayCostInfo">
    ...
    <ul>
      ...
      <li>It can be booked as a <i>regular</i> or as a <i>"one-off" service</i>.</li>
    </ul>
  </div>
